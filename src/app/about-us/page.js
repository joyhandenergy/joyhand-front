...
export default function AboutPage() {
  ...
  const jsonLd = {
    ...
    "mainEntity": {
      ...
      "name": "JoyHand Energy",
      "foundingDate": "1998",
      "description": "Direct-to-distributor factory engineering premium energy storage and off-grid solutions specifically to thrive in low-grid environments.",
      "knowsAbout": ["Lithium Iron Phosphate Batteries", "Hybrid Solar Inverters", "E-Mobility", "Off-grid Energy Systems"]
    }
  };
  ...
  return (
    <main className="about-page">
      ...
      <PageHeader
        ...
        subtitle="Since 1998, JoyHand has engineered premium energy storage and off-grid solutions designed specifically to thrive in low-grid environments across Africa and the global south."
      ...
      <section className="about-intro animate-slide-up">
        ...
        <div className="container about-intro__container">
          <div className="about-intro__content">
            <SectionHeader
              badge="DIRECT FACTORY PARTNERSHIP"
              title="A Factory-First Approach to Uninterrupted Power"
            />
            <div className="about-intro__description">
              <p>
                JoyHand Energy operates at the intersection of advanced manufacturing and practical field resilience. As a <strong>direct-to-distributor factory</strong>, we eliminate intermediaries to provide you with high-yield margins and absolute quality control. Our ISO 9001:2025 certified production lines are dedicated to building robust power electronics and battery systems that withstand power surges, high temperatures, and the extreme demands of low-grid regions across Africa and worldwide.
              </p>
              <div className="mission-statement">
                <h4 className="mission-statement__title">Our Manufacturing Guarantee</h4>
                <p className="mission-statement__text">
                  To secure your supply chain by delivering factory-direct, rigorously tested energy hardware. We empower wholesale distributors with OEM/ODM solutions that guarantee uninterrupted power.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ================= ENERGY SOLUTIONS (now includes Phone Screen Protectors) ================= */}
          ...
          <div className="abtCta-banner__wrapper">
            <div className="abtCta-banner__text">
              ...
              <p className="abtCta-banner__subtitle">
                Unlock Tier-1 OEM/ODM manufacturing, priority logistics, and customized engineering support for your energy business. Supplying wholesale distributors across Africa and worldwide off-grid markets.
              </p>
            </div>
            <button
